...
export default function DailyPredictions() {
  ...
  const columnDefs = [
    { field: 'predicted_date', headerName: 'predicted date', sortable: true, filter: 'agTextColumnFilter' },
    ...
    { field: 'predicted_trend', headerName: 'predicted_trend', sortable: true, filter: 'agTextColumnFilter', cellStyle: params => {
    ...
    { field: 'predicted_trading_range', headerName: 'predicted_trading_range', sortable: true, filter: 'agTextColumnFilter' },
    ...
    { field: 'opportunity', headerName: 'opportunity', sortable: true, filter: 'agTextColumnFilter', cellStyle: params => {
        if (params.value === 'LONG') return { color: '#50F178', fontWeight: 'bold' };
        if (params.value === 'SHORT') return { color: '#FF5555', fontWeight: 'bold' };
        return {};
      }
    },
    { field: 'conviction', headerName: 'conviction', sortable: true, filter: 'agTextColumnFilter', cellStyle: params => {
    ...
    { field: 'trend_direction', headerName: 'trend_direction', sortable: true, filter: 'agTextColumnFilter' }
  ];
